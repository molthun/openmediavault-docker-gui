...
Ext.define("OMV.module.admin.service.docker.ConnectNetwork", {
            ...
            items: [{
                ...
                store: Ext.create("OMV.data.Store", {
                    ...
                    proxy: {
                        ...
                        rpcData: {
                            service: "Docker",
                            method: "getContainersNotInSelectedNetwork",
                            params: {
    ...
    doSubmit: function() {
        ...
        var params = {
            ...
            ipaddress: me.getForm().findField("ipAddress").getValue()
        };
        //params.toString();
        if(me.mode === "remote") {
            var rpcOptions = {
